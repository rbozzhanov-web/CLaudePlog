...
function toEntry(entry: NewFlightLogEntry, id: string, now: string): FlightLogEntry {
...
export async function updateEntry(id: string, entry: NewFlightLogEntry): Promise<FlightLogEntry> {
