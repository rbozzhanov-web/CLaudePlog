...
/**
 * The years the pilot actually flew, newest first.
 *
 ...
 */
export function listYears(entries: FlightLogEntry[]): string[] {
...
export function filterByYear(entries: FlightLogEntry[], year: YearFilter): FlightLogEntry[] {
 ...
 *
 * Prefers the closest flight **on or before** the date — asked for "1 May", a pilot means "the
