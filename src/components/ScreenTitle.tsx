 ...
 *
 * The native tab bar draws no header of its own, so this is the single place a tab says what it
 * is — as a large title, which is what iOS 26 does anyway. The top inset is applied here because
 * without a header nothing else keeps the title out from under the status bar.
 */
